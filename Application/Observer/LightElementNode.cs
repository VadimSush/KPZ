...
namespace Observer
{
    public class LightElementNode : LightNode
    {
        ...
        public LightElementNode(string tagName, DisplayType displayType, IEnumerable<string> classList, IEnumerable<LightNode> childrens = null, ClosureType closureType = ClosureType.Double, Publisher? publisher = null)
        {
        ...
        public void AddMouseEventListener(string type, MouseHandler handler)
        {
            _publisher.Subscribe(type, handler);
        }

        public void RemoveMouseEventListener(string type, MouseHandler handler)
        {
            _publisher.Unsubscribe(type, handler);
        }
